...
function seleccionarModo(modo) {
    if (modo === 'game') {
        window.location.href = 'http://localhost:8012/Tricosaurus/pages/modes/game.php';
    } else if (modo === 'tracing') {
        window.location.href = 'http://localhost:8012/Tricosaurus/pages/modes/modoSeguimiento.php';
    }
}
